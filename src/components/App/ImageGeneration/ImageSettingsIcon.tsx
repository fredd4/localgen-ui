...
const ImageSettingsIcon: React.FC<React.SVGProps<SVGSVGElement>> = ({
  children,
  ...props
}) => {
  return (
    ...
    >
      ...
      <g
        transform="translate(-4 182) scale(1.08431)"
        style="transform-origin:242.01px -364.458px"
      >
        <path
          ...
          style="paint-order:fill;fill:transparent;stroke-width:20px"
        />
        <circle
          cx="383.3"
          cy="154.1"
          r="31.2"
          style="paint-order:fill;fill:transparent;stroke-width:14px"
        />
      </g>
      {children}
    </svg>
